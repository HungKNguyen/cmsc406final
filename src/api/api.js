async function API_SIGN_UP(login, password, name) {
...
async function API_SIGN_IN(login, password) {
    let result = [null, null]
...
async function API_GET_ALL_ACTIVITIES(start, end) {
    let result = [null, null]
    try {
...
async function API_GET_YOUR_ACTIVITIES() {
...
async function API_CREATE_ACTIVITIES(title, description, start, end) {
    const body = {
        title: title,
...
async function API_DELETE_ACTIVITIES(id) {
    let result = [null, null]
    const token = localStorage.getItem("jwt")
    try {
